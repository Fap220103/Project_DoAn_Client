  ...
  var h,
    ...
    r = (function () {
      function c(a, b, d, e, f) {
        ...
        this.dom = {
          ...
          conditionTitle: h('<option value="" disabled selected hidden/>').text(
          ...
          data: h('<select/>')
            ...
            .addClass(this.classes.dropDown)
            .addClass(this.classes.italic),
          dataTitle: h('<option value="" disabled selected hidden/>').text(
          ...
          valueTitle: h('<option value="--valueTitle--" selected/>').text(
      ...
      c.prototype.search = function (a, b) {
        ...
        if (void 0 !== this.s.condition && void 0 !== d) {
          ...
          this.s.type.includes('html') && (e = e.replace(/(<([^>]+)>)/gi, ''));
          null === e && (e = '');
        ...
        for (var u = [], C = [], H = 0; H < g.length; H++) {
          ...
          var J = function (w, y) {
            w = h('<option>', {
              ...
              value:
                a.s.type.includes('html') && null !== w && 'string' === typeof w
                  ? w.replace(/(<([^>]+)>)/gi, '')
                  : w
            })
              .addClass(a.classes.option)
            ...
            -1 === u.indexOf(y) &&
              ...
              null !== d &&
                w.val() === d[0] &&
                (w.prop('selected', !0), q.removeClass(c.classes.italic)));
          };
      ...
      c.isInputValidSelect = function (a) {
        for (var b = !0, d = 0; d < a.length; d++) {
          ...
          e.children('option:selected').length ===
            ...
            e.children('option:selected')[0] === e.children('option:hidden')[0] &&
            (b = !1);
        }
        return b;
      };
      ...
      c.inputValueSelect = function (a) {
        for (var b = [], d = 0; d < a.length; d++) {
          ...
          if (e.is('select')) {
            ...
            b.push(
              'Array' === e.children('option:selected').attr('type') ? f.split(',').sort() : f
            );
          }
        }
        return b;
    ...
    G = (function () {
      ...
      c.prototype._setGroupListeners = function (a) {
        ...
        a.dom.container.unbind('dtsb-destroy').on('dtsb-destroy', function () {
          b._removeCriteria(a, !0);
          a.dom.container.remove();
          b.setupLogic();
          return !1;
        });
        a.dom.container.unbind('dtsb-dropCriteria').on('dtsb-dropCriteria', function () {
          var d = a.s.toDrop;
          d.s.index = a.s.index;
    ...
    I = (function () {
      ...
      c.prototype._setUp = function (a) {
        var b = this;
        void 0 === a && (a = !0);
        x.fn.DataTable.Api.registerPlural('columns().type()', 'column().type()', function (n, q) {
  ...
  (function (c) {
    ...
    c.fn.dataTable.ext.buttons.searchBuilder = {
      action: function (f, g, n, q) {
        this.popover(q._searchBuilder.getNode(), { align: 'dt-container' });
