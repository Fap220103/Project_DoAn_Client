...
(function () {
  ...
  var Criteria = /** @class */ (function () {
    function Criteria(table, opts, topGroup, index, depth) {
      ...
      this.dom = {
        ...
        conditionTitle: $$2('<option value="" disabled selected hidden/>').text(
        ...
        data: $$2('<select/>')
          ...
          .addClass(this.classes.dropDown)
          .addClass(this.classes.italic),
        dataTitle: $$2('<option value="" disabled selected hidden/>').text(
        ...
        valueTitle: $$2('<option value="--valueTitle--" selected/>').text(
      ...
      for (var _i = 0, indexArray_1 = indexArray; _i < indexArray_1.length; _i++) {
        ...
        var addOption = function (filt, text) {
          ...
          var opt = $$2('<option>', {
            ...
            value:
              that.s.type.includes('html') && filt !== null && typeof filt === 'string'
                ? filt.replace(/(<([^>]+)>)/gi, '')
                : filt
          })
  ...
  var Group = /** @class */ (function () {
    ...
    Group.prototype._setGroupListeners = function (group) {
      ...
      group.dom.container.unbind('dtsb-destroy').on('dtsb-destroy', function () {
        _this._removeCriteria(group, true);
        group.dom.container.remove();
        _this.setupLogic();
        return false;
      });
      group.dom.container.unbind('dtsb-dropCriteria').on('dtsb-dropCriteria', function () {
    ...
    Group.prototype._toggleLogic = function () {
      if (this.s.logic === 'OR') {
        ...
        this.dom.logic
          .children()
          .first()
          .text(this.s.dt.i18n('searchBuilder.logicAnd', this.c.i18n.logicAnd));
      } else if (this.s.logic === 'AND') {
        this.s.logic = 'OR';
        this.dom.logic
          .children()
          .first()
          .text(this.s.dt.i18n('searchBuilder.logicOr', this.c.i18n.logicOr));
      }
    };
    Group.version = '1.1.0';
    Group.classes = {
