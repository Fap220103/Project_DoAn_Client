      ...
      t = function (x) {
        if (c === q || c === f)
          (g = n[f]),
            (k = x.innerHTML.trim()),
            g && g._bAttrSrc
              ? (ha(g.mData._)(d, k), p(g.mData.sort, x), p(g.mData.type, x), p(g.mData.filter, x))
              : m
  ...
  function Eb(a) {
    ...
    for (b = f.length; k < b; k++) {
      ...
      a.oFeatures.bSort &&
        ...
        !1 !== n.bSortable &&
          (m.attr('tabindex', a.iTabIndex).attr('aria-controls', a.sTableId), eb(a, n.nTh, k)));
    ...
    for (var h = a.sDom.split(''), g, f, k, n, m, p, t = 0; t < h.length; t++) {
      ...
      if ('<' == f) {
        ...
        if ("'" == n || '"' == n) {
          ...
          -1 != m.indexOf('.')
            ? ((n = m.split('.')), (k.id = n[0].substr(1, n[0].length - 1)), (k.className = n[1]))
            : '#' == m.charAt(0)
  ...
  function Ha(a) {
    ...
    if (a.scrollBarVis !== fa && a.scrollBarVis !== q) (a.scrollBarVis = fa), ta(a);
      ...
      '' === c
        ? ((C.width = '100%'),
          L &&
            (w.find('tbody').height() > f.offsetHeight || 'scroll' == m.css('overflow-y')) &&
      ...
      this.each(function () {
        ...
        if ('table' != this.nodeName.toLowerCase())
          ...
          r.iInitDisplayStart === q &&
            ((r.iInitDisplayStart = f.iDisplayStart), (r._iDisplayStart = f.iDisplayStart));
        ...
        if (null === w || w === q || r) {
          ...
          for (p = e.length; m < p; m++)
            for (f = e[m], t = 0; t < k; t++)
              (v = { row: f, column: t }),
                r
                  ? ((x = d[f]), w(v, T(a, f, t), x.anCells ? x.anCells[t] : null) && n.push(v))
                  : n.push(v);
          return n;
        }
        ...
        l(a.nTable).on('order.dt.DT', function (e, h, g, f) {
          a === h &&
            ...
            b
              ...
              .addClass(
                'asc' == f[e] ? d.sSortAsc : 'desc' == f[e] ? d.sSortDesc : c.sSortingClass
              ));
        });
      },
        ...
        l(a.nTable).on('order.dt.DT', function (e, h, g, f) {
          a === h &&
            ...
            b
              ...
              .addClass(
                'asc' == f[e] ? d.sSortJUIAsc : 'desc' == f[e] ? d.sSortJUIDesc : c.sSortingClassJUI
              ));
        });
      }
    }
