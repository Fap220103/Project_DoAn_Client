...
(function (e) {
  ...
  e.extend(o.prototype, {
    ...
    add: function (a, b) {
      ...
      if ('string' === typeof b) {
        for (var d = b.split('-'), e = this.s, c = 0, h = d.length - 1; c < h; c++)
          e = e.buttons[1 * d[c]];
        c = e.buttons;
        b = 1 * d[d.length - 1];
      }
    ...
    _expandButton: function (a, b, c, d) {
      for (
        var f = this.s.dt, h = 0, b = !Array.isArray(b) ? [b] : b, i = 0, k = b.length;
        i < k;
        i++
      ) {
              ...
              if (i.key === a) (b._buttonsHandled = !0), e(k).click();
                ...
                if (!i.key.altKey || b.altKey)
                  if (!i.key.ctrlKey || b.ctrlKey)
                    if (!i.key.metaKey || b.metaKey) (b._buttonsHandled = !0), e(k).click();
    ...
    _popover: function (a, b, c) {
      ...
      f.collectionTitle &&
        c.prepend('<div class="dt-button-collection-title">' + f.collectionTitle + '</div>');
      ...
      if ('absolute' === k) {
        ...
        'dt-container' === f.align
          ? ((n = 0),
            c.hasClass(f.rightAlignClassName)
              ? ((n = l - g),
                k > m + n && ((k -= m + n), (d -= g + n), (n = k > d ? n + d : n + k)))
              : ((n = k - m),
                d < g + n && ((k -= m + n), (d -= g + n), (n = k > d ? n + d : n + k))))
      ...
      var c = [],
        ...
        f = function (a, b) {
          ...
          if (Array.isArray(a) || a instanceof e) {
            ...
            'object' === typeof a &&
              a.nodeName &&
              ((i = e.inArray(a, g)), -1 !== i && c.push({ inst: b, node: g[i] }));
        },
        h = 0,
        i = a.length;
      h < i;
  ...
  j.Api.register('buttons().containers()', function () {
    ...
    this.iterator(!0, 'table', function (c) {
      if (c._buttons)
        for (var c = o.instanceSelector(b, c._buttons), d = 0, e = c.length; d < e; d++)
  ...
  j.Api.register('button().add()', function (a, b) {
    var c = this.context;
    c.length &&
      ((c = o.instanceSelector(this._groupSelector, c[0]._buttons)), c.length && c[0].add(b, a));
