              ...
              if (
                ...
                for (var S = E; void 0 !== (x = y.shift()); ) {
                  ...
                  if (
                    ...
                    (g = u.EventHandlers.keypressEvent.call(l, w, !0, !1, a, S)) &&
                      void 0 !== g.pos &&
                      g.pos !== x &&
                      c.validPositions[g.pos] &&
                      !0 === c.validPositions[g.pos].match.static)
            ...
            (t.determineLastRequiredPosition = function (e) {
              ...
              for (
                ...
                ((a = d[t]).match.optionality ||
                  ...
                  (m &&
                    ((m !== d[t].locator[p.alternation] && 1 != a.match.static) ||
                      (!0 === a.match.static &&
                ...
                if (void 0 !== n.matches) {
                  if (n.isGroup && f !== n) {
                    ...
                    if (-1 === T || 'string' == typeof T) {
                      ...
                      (!0 === u.keepStatic ||
                        (isFinite(parseInt(u.keepStatic)) && C >= u.keepStatic)) &&
                        (B = B.slice(0, 1));
                      for (var F = 0; F < B.length; F++) {
                        (A = parseInt(B[F])),
                          (h = []),
                          (a = ('string' == typeof T && k(d, A, _)) || D.slice());
                        var N = S.matches[A];
                    ...
                    for (
                      ...
                      q < (isNaN($.quantifier.max) ? q + 1 : $.quantifier.max) && d <= e;
                      q++
                    ) {
                      var z = t.matches[t.matches.indexOf($) - 1];
                      if ((n = o(z, [q].concat(r), z))) {
                        if (
                          (((i = h[h.length - 1].match).optionalQuantifier = q >= $.quantifier.min),
                          (i.jit = (q + 1) * (z.matches.indexOf(i) + 1) > $.quantifier.jit),
                        ...
                        return (
                          i.jit && (s.jitOffset[e] = z.matches.length - z.matches.indexOf(i)), !0
                        );
                      }
                    }
              ...
              do {
                if (!0 === e && f.validPositions[k])
                  (m =
                    ...
                    (h = m.match),
                    (p = m.locator.slice()),
                    g.push(!0 === a ? m.input : !1 === a ? h.nativeDef : n.call(l, k, h));
                else {
                  (m = r.call(l, k, p, k - 1)), (h = m.match), (p = m.locator.slice());
                  var y = !0 !== i && (!1 !== c.jitMasking ? c.jitMasking : h.jit);
                  (v =
                    ((v && h.static && h.def !== c.groupSeparator && null === h.fn) ||
            ...
            if (void 0 !== c) {
              ...
              for (
                ...
                for (
                  ...
                  h < A.length &&
                  ((g = _.caret || o.getLastValidPosition.call(x, void 0, !0) + 1),
                  (k = A[h]),
          ...
          function f(e, t, a, i, r, s, d) {
              ...
              return (
                n.getTests.call(v, t).every(function (l, c) {
                  ...
                  if (
                    ...
                    !1 !==
                      (s =
                        (!f.jit || void 0 !== y.validPositions[o.seekPrevious.call(v, t)]) &&
                        (null != f.fn
            ...
            if (
              ('function' == typeof k.preValidation &&
                ...
                !0 !== s &&
                (S = P(
                  (S = k.preValidation.call(v, o.getBuffer.call(v), x, t, b(e), k, y, e, a || r))
                )),
              !0 === S)
            ) {
            ...
            S && void 0 === S.pos && (S.pos = x),
              !1 === S || !0 === s
                ? (o.resetMaskSet.call(v, !0), (y.validPositions = g.extend(!0, {}, w)))
                : h.call(v, void 0, x, !0);
            var D = P(S);
            void 0 !== v.maxLength &&
              o.getBuffer.call(v).length > v.maxLength &&
              !i &&
              (o.resetMaskSet.call(v, !0), (y.validPositions = g.extend(!0, {}, w)), (D = !1));
            return D;
          }
          function d(e, t, a) {
            for (
          ...
          function m(e, t, a, i) {
            ...
            if (
              ...
              var b,
                ...
                E = P;
              for (
                t && ((s.validPositions[i] = u.extend(!0, {}, t)), E++, P++), g = t ? m : m - 1;
                g <= y;
                g++
              ) {
                if (
