...
var FullCalendar = (function (e) {
    ...
    for (n.__k = [], p = 0; p < t.length; p++)
      if (
        ...
        P(e, v, (h = h || c), o, i, a, s, l, u),
          ...
          (f = v.ref) &&
            h.ref != f &&
            (D || (D = []), h.ref && D.push(h.ref, null, v), D.push(f, v.__c || y, v)),
          null != y
            ? (null == S && (S = y),
  ...
  function Mn(e, t, n, r, o) {
    ...
    if (u)
      return (
        ((c = Nn(a, s, t ? t.sourceId : '', u.allDay, Boolean(u.duration), n)).recurringDef = {
          typeId: u.typeId,
          typeData: u.typeData,
          duration: u.duration
        }),
  ...
  function pr(e, t, n) {
    n.emitter.trigger(
      'select',
      r(r({}, fr(e, n)), { jsEvent: t ? t.origEvent : null, view: n.viewApi || n.calendarApi.view })
    );
  }
  function fr(e, t) {
    ...
    return (
      r(i, ((n = e), (o = t.dateEnv), r(r({}, cr(n.range, o, n.allDay)), { allDay: n.allDay }))), i
    );
  }
  function hr(e, t, n) {
    var r = n.dateEnv,
      ...
      return (
        ...
        (e.prototype.addEvent = function (e, t) {
          if (e instanceof wr) {
            ...
            return (
              this.getCurrentData().eventStore.defs[n.defId] ||
                (this.dispatch({ type: 'ADD_EVENTS', eventStore: gn({ def: n, instance: r }) }),
          ...
          if (s) {
            ...
            return (
              this.dispatch({ type: 'ADD_EVENTS', eventStore: gn(s) }), this.triggerEventAdd(l), l
            );
          }
          return null;
        }),
      ...
      return (
        (e.prototype.setProp = function (e, t) {
          ...
          if (e in kn)
            ...
            (t = Tn[e](t)), this.mutate({ standardProps: ((n = {}), (n[e] = t), n) });
          else if (e in bn) {
            var o = bn[e](t);
            'color' === e
  ...
  function Or(e) {
    for (
      var t = e.length > 0 ? e[0].code : 'en', n = Nr.concat(e), r = { en: Hr }, o = 0, i = n;
      o < i.length;
      o++
    ) {
      var a = i[o];
  ...
  var xo = (function (e) {
    ...
    return (
      ...
      (t.prototype.shouldComponentUpdate = function (e, t) {
        return (
          this.debug && console.log(Dt(e, this.props), Dt(t, this.state)),
  ...
  var Jo = (function () {
    ...
    return (
      ...
      (e.prototype.adjustActiveRange = function (e) {
        ...
        return (
          r &&
            ...
            Nt(i) > 1 && ((s = $e((s = ot(s)), -1)), (s = n.add(s, i)))),
          { start: a, end: s }
        );
      }),
      (e.prototype.buildRangeFromDuration = function (e, t, n, r) {
        ...
        return (
          Nt(n) <= 1 && this.isHiddenDay(o) && (o = ot((o = this.skipHiddenDays(o, t)))),
          d(),
      ...
      return (
        ...
        (e.prototype.splitEntry = function (e, t, n) {
          ...
          return (
            ...
            r
              ? (n.push.apply(
                  n,
                  o([{ index: e.index, thickness: e.thickness, span: ji(s, a) }], i)
                ),
                r)
              : (n.push(e), 0)
          );
        ...
        (e.prototype.findInsertion = function (e) {
          for (
            ...
            for (
              var h = r[p], v = void 0, g = qi(h, e.span.start, Vi), m = g[0] + g[1];
  ...
  function zi(e) {
    for (var t = [], n = 0, r = e; n < r.length; n++) {
      for (
        ...
        var u = l[s];
        ji(u.span, a.span)
          ? (a = { entries: u.entries.concat(a.entries), span: Bi(u.span, a.span) })
          : i.push(u);
      }
      i.push(a), (t = i);
    }
        ...
        (t.prototype.renderWidgetGroup = function (e) {
          for (
            ...
            var u = l[s],
              ...
              f = u.buttonIcon;
            if ('title' === c)
              (a = !1), i.push(yo('h2', { className: 'fc-toolbar-title' }, t.title));
            else {
  ...
  var Ea = (function () {
      function e(e, t) {
        for (var n = e.start, r = e.end, o = [], i = [], a = -1; n < r; )
          t.isHiddenDay(n) ? o.push(a + 0.5) : ((a += 1), o.push(a), i.push(n)), (n = $e(n, 1));
      ...
      return (
        ...
        (e.prototype.sliceNowDate = function (e, t) {
          ...
          return this._sliceDateSpan.apply(
            this,
            o([{ range: { start: e, end: Je(e, 1) }, allDay: !1 }, {}, t], n)
          );
        }),
        (e.prototype._sliceBusinessHours = function (e, t, n, r) {
          for (var i = [], a = 4; a < arguments.length; a++) i[a - 4] = arguments[a];
          return e
            ? this._sliceEventStore.apply(this, o([Rt(e, ba(t, Boolean(n)), r), {}, t, n], i)).bg
            : [];
        }),
        ...
        (e.prototype._sliceDateSpan = function (e, t, n) {
          ...
          if (!e) return [];
          for (
            var a = dr(e, t, n), s = this.sliceRange.apply(this, o([e.range], r)), l = 0, u = s;
            l < u.length;
            l++
          ) {
            var c = u[l];
          ...
          return yo(
            ...
            function (t, o, i, a, s) {
              return yo(
                ...
                s.isStartResizable &&
                  yo('div', { className: 'fc-event-resizer fc-event-resizer-start' }),
                s.isEndResizable &&
                  yo('div', { className: 'fc-event-resizer fc-event-resizer-end' })
              );
            }
          );
        }),
  ...
  function Ka(e) {
    return yo(
      ...
      yo(
        ...
        yo('div', { className: 'fc-event-title fc-sticky' }, e.event.title || yo(Do, null, ' '))
      )
    );
  }
  var $a = function (e) {
      ...
      return (
        ...
        (o.handleRenderRequest = function () {
          if (o.isRendering) {
            ...
            o.isRendered && ((o.isRendered = !1), Ro(o.el), o.setClassNames([]), o.setHeight(''));
          wo();
        }),
        (o.el = t),
      ...
      function t(t) {
        ...
        (n.dragSelection = null),
          ...
          (n.handlePointerUp = function (e) {
            n.dragSelection &&
              (pr(n.dragSelection, e, n.component.context), (n.dragSelection = null));
          });
      ...
      (n.draggingSegEl = null),
        ...
        (n.handleHitUpdate = function (e, t, r) {
          ...
          l &&
            ...
            c ? Oe() : Ae(),
            t ||
              (l && Ms(a, e) && (l = null), (n.validMutation = l), (n.mutatedRelevantEvents = u));
        }),
        (n.handleDragEnd = function (e) {
          var t = n.component.context,
            o = n.eventRange.def,
      ...
      (t.prototype.render = function () {
        ...
        return yo(
          ...
          function (e, t, n, r, o) {
            return yo(
              'a',
              { ref: e, className: ['fc-daygrid-more-link'].concat(t).join(' '), onClick: o },
              r
            );
          }
        );
              ...
              D &&
                ...
                f.push(
                  yo(
                    ...
                    {
                      className:
                        'fc-daygrid-event-harness' + (D ? ' fc-daygrid-event-harness-abs' : ''),
                      key: E,
          ...
          if (a)
            for (var l = 0, u = e; l < u.length; l++) {
              ...
              s.push(
                yo(
                  'div',
                  { key: ir(c.eventRange), className: 'fc-daygrid-bg-harness', style: d },
          ...
          (t.renderHeadAxis = function (e, n) {
            ...
            return o.weekNumbers && 'day' === e
              ...
              : yo(
                  ...
                  yo('div', { className: 'fc-timegrid-axis-frame', style: { height: n } })
                );
          }),
                  ...
                  content: function (e) {
                    return yo(
                      ...
                      yo(
                        ...
                        e.tableColGroupNode,
                        yo('tbody', null, yo(Sl, { slatMetas: i }))
                      ),
                      yo(
                        'div',
          ...
          var t = [],
            n = Ol(
              ...
              function (e, n, i) {
                ...
                return (
                  t.push(a), (a.stackForward = o(e.nextLevelNodes, n + e.thickness, i + 1) + 1)
                );
              }
            );
          function o(e, t, r) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return (
            ...
            yo(Xa, r({}, this.props, { defaultTimeFormat: Ul, extraClassNames: e }))
          );
        }),
        t
      );
        ...
        (t.prototype.renderPositionedFgSegs = function (e, t, n, o, i) {
          var a = this,
            ...
            E = (function (e, t, n, r) {
              ...
              for (
                var l = Pl(o, n, r), u = l.segRects, c = l.hiddenGroups, d = [], p = 0, f = u;
                p < f.length;
                p++
              ) {
                var h = f[p];
        ...
        (t.prototype.renderFillSegs = function (e, t) {
          var n = this.props,
            ...
            i = Al(e, n.date, n.slatCoords, o.options.eventMinHeight).map(function (o, i) {
              ...
              return yo(
                'div',
                { key: ir(a.eventRange), className: 'fc-timegrid-bg-harness', style: zl(o) },
  ...
  function Kl(e, t, n, r, o) {
    for (
      ...
      var c = o.add(i, a),
        d = null !== Ot(s, l);
      u.push({ date: c, time: a, key: c.toISOString(), isoTimeStr: Wt(c), isLabeled: d }),
        (a = Pt(a, r)),
        (s = Pt(s, r));
    }
    return u;
        ...
        (t.prototype.render = function () {
          ...
          return yo(
            ...
            function (e, n, r, o) {
              return yo(
                'tr',
                { ref: e, className: h.concat(n).join(' '), 'data-date': Lt(t) },
                yo(
                  'th',
                  { colSpan: 3 },
                  yo(
  ...
  function tu(e) {
    ...
    return yo(
      ...
      e.sideText && yo('a', r({ className: 'fc-list-day-side-text' }, t), e.sideText)
    );
  }
    ...
    return (
      ...
      (t.prototype._eventStoreToSegs = function (e, t, n) {
        return this.eventRangesToSegs(
          Gn(e, t, this.props.dateProfile.activeRange, this.context.options.nextDayThreshold).fg,
          n
        );
      }),
            ...
            var u = (function (e) {
              ...
              p = (function (e, t, n, o) {
                ...
                o.canComputeOffset
                  ...
                  : ((a = $e(e.start, -1).toISOString()), (s = $e(e.end, 1).toISOString()));
                (i = r(r({}, n || {}), {
                  key: t,
                  timeMin: a,
                  timeMax: s,
