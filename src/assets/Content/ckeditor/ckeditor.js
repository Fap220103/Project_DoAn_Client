...
(function () {
  ...
  CKEDITOR.env ||
    (CKEDITOR.env = (function () {
      ...
      a.cssClass =
        'cke_browser_' +
        (a.ie ? 'ie' : a.gecko ? 'gecko' : a.opera ? 'opera' : a.webkit ? 'webkit' : 'unknown');
      if (a.quirks) a.cssClass = a.cssClass + ' cke_browser_quirks';
      if (a.ie) {
        a.cssClass =
          a.cssClass + (' cke_browser_ie' + (a.quirks || a.version < 7 ? '6' : a.version));
      ...
      removeAllListeners: function () {
        ...
        for (a in b) {
          ...
          this.$.detachEvent
            ...
            : this.$.removeEventListener && this.$.removeEventListener(a, f, false);
          delete b[a];
        }
      }
    };
  ...
  CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
    ...
    getPosition: function (b) {
      ...
      for (
        var c = this.getAddress(), b = b.getAddress(), a = Math.min(c.length, b.length), f = 0;
        f <= a - 1;
        f++
      )
        if (c[f] != b[f]) {
      ...
      removeStyle: function (a) {
        ...
        if (!b.removeProperty && (a == 'border' || a == 'margin' || a == 'padding')) {
          ...
          for (var b = [], h = 0; h < c.length; h++)
            if (e) for (var j = 0; j < e.length; j++) b.push([a, c[h], e[j]].join('-'));
  ...
  (function () {
    ...
    CKEDITOR.dom.element.prototype.isBlockBoundary = function (b) {
      ...
      return (
        (this.getComputedStyle('float') == 'none' && a[this.getComputedStyle('display')]) ||
        b[this.getName()]
      );
    };
    ...
    CKEDITOR.dom.walker.bogus = function (a) {
      ...
      return function (c) {
        ...
        if (d) {
          ...
          c = c.getNext(b);
          d =
            d.isBlockBoundary() && (!c || (c.type == CKEDITOR.NODE_ELEMENT && c.isBlockBoundary()));
        }
        return !!(a ^ d);
      };
    };
    ...
    CKEDITOR.dom.element.prototype.getBogus = function () {
      ...
      return a && (!CKEDITOR.env.ie ? a.is && a.is('br') : a.getText && f.test(a.getText()))
        ? a
        : false;
    };
  })();
  ...
  (function () {
    ...
    function c(a) {
      ...
      return function (k) {
        return c(k) || b(k)
          ? true
          : (!a && h(k)) || (k.type == CKEDITOR.NODE_ELEMENT && k.is(CKEDITOR.dtd.$removeEmpty));
      };
    }
    function a(a) {
      return !j(a) && !i(a);
      ...
      enlarge: function (a, b) {
        switch (a) {
                  ...
                  if (h.type == CKEDITOR.NODE_TEXT) {
                    ...
                    if (j && CKEDITOR.dtd.$removeEmpty[h.getName()]) {
                      ...
                      if (/[^\s\ufeff]/.test(x)) h = null;
                        ...
                        for (var l = h.$.getElementsByTagName('*'), s = 0, C; (C = l[s++]); )
          ...
          case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
            ...
            this.setStartAt(
              y,
              !y.is('br') && ((!e && this.checkStartOfBlock()) || (e && y.contains(e)))
    ...
    b.prototype = {
      getNextParagraph: function (b) {
        ...
        if (!this._.started) {
          ...
          m =
            i.endContainer.hasAscendant('pre', true) || i.startContainer.hasAscendant('pre', true);
          i.enlarge(
      ...
      if (B.$empty[d] || !a.children.length)
        ...
        if (b == 'br') {
          ...
          if (g) {
            ...
            g = a.parent;
            for (
              var e = g.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || g.name == 'body',
                p,
                f = d.length;
              f > 0;
    ...
    function b(b, e, f) {
      ...
      if (e !== void 0) {
        ...
        if (
          ...
          throw Error(
            'The specified element mode is not supported on element: "' + e.getName() + '".'
          );
        this.element = e;
        this.elementMode = f;
        this.name =
          this.elementMode != CKEDITOR.ELEMENT_MODE_APPENDTO && (e.getId() || e.getNameAtt());
  ...
  (function () {
    ...
    CKEDITOR.htmlParser.fragment.fromHtml = function (d, e, h) {
      ...
      k.onTagOpen = function (d, e, g, h) {
        ...
        if (b(e)) p.push(e);
          ...
          if (d == 'br') v.push(e);
            ...
            for (;;) {
              h = (g = t.name)
                ? CKEDITOR.dtd[g] || (t._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span)
                : f;
      ...
      k.onText = function (b) {
        ...
        if (!n && !e['#'] && d in c) {
          k.onTagOpen(
            d in a ? 'li' : d == 'dl' ? 'dd' : d == 'table' ? 'tr' : d == 'tr' ? 'td' : ''
          );
          k.onText(b);
        } else {
          i();
    ...
    CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
      ...
      proto: {
        ...
        onElement: function (a) {
          for (
            var b = [this._.elements['^'], this._.elements[a.name], this._.elements.$], c, d = 0;
            d < 3;
            d++
          )
            if ((c = b[d])) {
  ...
  (function () {
    ...
    CKEDITOR.htmlDataProcessor.prototype = {
      toHtml: function (a, b, c, d) {
        ...
        return g.fire('toHtml', { dataValue: a, context: b, fixForBody: c, dontFilter: !!d })
          .dataValue;
      },
  ...
  (function () {
    ...
    CKEDITOR.editor.prototype.resize = function (a, b, c, f) {
      ...
      l.setStyle(
        'height',
        Math.max(b - (c ? 0 : (f.$.offsetHeight || 0) - (l.$.clientHeight || 0)), 0) + 'px'
      );
      m && (m.style.width = '100%');
      this.fire('resize');
    };
  ...
  (function () {
    ...
    CKEDITOR.editable = CKEDITOR.tools.createClass({
      ...
      proto: {
        focus: function () {
          this.$[
            CKEDITOR.env.ie && this.getDocument().equals(CKEDITOR.document) ? 'setActive' : 'focus'
          ]();
          CKEDITOR.env.safari &&
            !this.isInline() &&
              ...
              if (c in { 8: 1, 46: 1 }) {
                ...
                if ((e = d(e))) {
                  ...
                  if (
                    ...
                    b.checkBoundaryOfElement(k, c ? CKEDITOR.START : CKEDITOR.END) &&
    ...
    var m = (function () {
      ...
      return function (n, l, z) {
        ...
        if (!C.checkReadOnly()) {
          ...
          for (
            ;
            (D = b(s.startContainer) && s.startContainer.getChild(s.startOffset - 1)) &&
            b(D) &&
            D.isBlockBoundary() &&
            I.contains(D);
          ...
          if (O)
            for (; (H = O.pop()); )
              H.append(
                CKEDITOR.env.ie ? J.document.createText(' ') : J.document.createElement('br')
              );
  ...
  (function () {
              ...
              k.on('mousedown', function (a) {
                function b(a) {
                  ...
                  if (g) {
                    ...
                    g.setEndPoint(
                      f.compareEndPoints('StartToStart', c) < 0 ? 'EndToEnd' : 'StartToStart',
                      c
                    );
                    g.select();
                  }
    ...
    CKEDITOR.dom.selection = function (a) {
      ...
      if (CKEDITOR.env.webkit)
        ...
        if (q)
          b.type == 'None' && c && c.equals(this.document.getDocumentElement()) && j(a, null, true);
        else {
          ...
          if (b)
            for (var d = c.ranges, e = 0; e < d.length; e++) {
              ...
              if (!f.collapsed) {
                ...
                b &&
                  b.type == CKEDITOR.NODE_TEXT &&
                  (i >= b.getLength() ? j.setStartAfter(b) : j.setStartBefore(b));
          ...
          c = CKEDITOR.tools.tryThese(
            ...
            function () {
              for (
                ...
                e &&
                (!(c = a.getEnclosedNode()) ||
                  !(c.type == CKEDITOR.NODE_ELEMENT && w[c.getName()] && (d = c)));
                e--
              )
          ...
          if (this.isLocked) {
            ...
            if (q) {
              ...
              ((b.startContainer.type == CKEDITOR.NODE_ELEMENT &&
                ...
                (b.endContainer.type == CKEDITOR.NODE_ELEMENT && b.endContainer.getName() in h)) &&
              ...
              if (z) {
                ...
                i =
                  ...
                  (l || !h.hasPrevious() || (h.getPrevious().is && h.getPrevious().is('br')));
  ...
  (function () {
      ...
      if ((b = b && b.attributes))
        for (var d = 0; d < b.length; d++) {
          ...
          if ((f = a.getAttribute(e))) {
            var h = b[d][1];
            (h === null || (h.test && h.test(f)) || (typeof h == 'string' && f == h)) &&
              a.removeAttribute(e);
          }
        }
      c || g(a);
    ...
    CKEDITOR.style = function (a, b) {
      ...
      this.type =
        a.type ||
        (r[c] ? CKEDITOR.STYLE_BLOCK : x[c] ? CKEDITOR.STYLE_OBJECT : CKEDITOR.STYLE_INLINE);
    ...
    CKEDITOR.skin = {
      ...
      loadPart: function (c, d) {
        CKEDITOR.skin.name != CKEDITOR.skinName.split(',')[0]
          ? CKEDITOR.scriptLoader.load(CKEDITOR.getUrl(b() + 'skin.js'), function () {
              a(c, d);
            })
          : a(c, d);
      },
  ...
  (function () {
    if (CKEDITOR.env.webkit) CKEDITOR.env.hc = false;
      ...
      try {
        CKEDITOR.env.hc =
          b.getComputedStyle('border-top-color') == b.getComputedStyle('border-right-color');
      } catch (c) {
...
*/
  ...
  (function () {
      ...
      this.parts.tabs.on(
        ...
        function (a) {
          ...
          b.hasClass('cke_dialog_tab') &&
            ...
            this._.tabBarMode && ((this._.tabBarMode = !1), (this._.currentFocusIndex = -1), d(1)),
            a.data.preventDefault());
        },
        this
      );
    ...
    CKEDITOR.dialog.prototype = {
      ...
      layout: function () {
        ...
        CKEDITOR.env.ie6Compat ||
          (b.height + (0 < e ? e : 0) > c.height || b.width + (0 < d ? d : 0) > c.width
      ...
      CKEDITOR.ui.dialog = {
        uiElement: function (a, b, c, d, e, g, f) {
          if (!(4 > arguments.length)) {
            ...
            for (
              var l = h['class'] && h['class'].split ? h['class'].split(' ') : [], i = 0;
              i < l.length;
              i++
            )
              l[i] && (n[l[i]] = 1);
              ...
              function () {
                ...
                b.push(
                  ...
                  CKEDITOR.tools.htmlEncode(
                    (e && e.align) || ('ltr' == a.getParentEditor().lang.dir ? 'left' : 'right')
                  ),
                  '" '
                );
                b.push('><tbody>');
            ...
            for (
              ...
              k.evaluator = function (a) {
                return !!(
                  ...
                  (a.getPosition(m) & (CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_CONTAINS)) ==
                    CKEDITOR.POSITION_PRECEDING
                );
              };
          ...
          CKEDITOR.tools.setTimeout(
            function () {
              var a = CKEDITOR.tools.bind(function () {
                ...
                m
                  ? h < c && (f = i > c ? f + c : b.width > c ? f - a.left : f - a.right + b.width)
                  : h < c && (f = i > c ? f - c : b.width > c ? f - a.right + b.width : f - a.left);
                c = a.top;
                b.height - a.top < g &&
  ...
  CKEDITOR.plugins.add('colorbutton', {
    ...
    init: function (c) {
        ...
        var h = [],
          ...
          j = CKEDITOR.tools.addFunction(function (a, b) {
            if ('?' == a) {
              ...
              c.fire('saveSnapshot');
              c.removeStyle(
                new CKEDITOR.style(i['colorButton_' + b + 'Style'], { color: 'inherit' })
              );
              if (a) {
      ...
      CKEDITOR.env.hc ||
        (m('TextColor', 'fore', f.textColorTitle, 10), m('BGColor', 'back', f.bgColorTitle, 20));
    }
  });
          ...
          addTarget: function (b, d) {
            ...
            b.on(
              ...
              function (a) {
                ...
                if (
                  !d ||
                  !(CKEDITOR.env.webkit ? e : CKEDITOR.env.mac ? a.$.metaKey : a.$.ctrlKey)
                ) {
                  a.preventDefault();
  ...
  (function () {
    function w(a) {
      function d() {
        for (
          var b = i(), e = CKEDITOR.tools.clone(a.config.toolbarGroups) || n(a), f = 0;
          f < e.length;
          f++
        ) {
          var k = e[f];
        ...
        r = CKEDITOR.tools.addFunction(function (b, e) {
          ...
          switch (e.getKeystroke()) {
            ...
            case CKEDITOR.SHIFT + 9:
              return (
                (f = CKEDITOR.document.getById(c + (b - 1))) ||
                  (f = CKEDITOR.document.getById(c + (a._.elementsPath.list.length - 1))),
                f.focus(),
                !1
              );
            case 27:
  ...
  (function () {
    function g(a, b, g, h, j, n, k, o) {
      for (
        var p = a.config, l = new CKEDITOR.style(k), c = j.split(';'), j = [], f = {}, d = 0;
        d < c.length;
        d++
      ) {
        var e = c[d];
    ...
    CKEDITOR.plugins.add('iframe', {
      ...
      init: function (a) {
        ...
        a.plugins.dialogadvtab &&
          (c +=
            ';iframe' + a.plugins.dialogadvtab.allowedContent({ id: 1, classes: 1, styles: 1 }));
  ...
  (function () {
    ...
    f.prototype = {
      ...
      refresh: function (a, c) {
        ...
        this.setState(
          'body' != b.getName() && l(b, this.editor.config.useComputedState) == this.value
            ? CKEDITOR.TRISTATE_ON
            : CKEDITOR.TRISTATE_OFF
        );
      }
  ...
  (function () {
    ...
    function v(c, j, f) {
      ...
      for (; f.checkStartOfBlock() && f.checkEndOfBlock(); )
        (g = f.startPath()),
          (b = g.block),
          b.is('li') &&
            ((e = b.getParent()), b.equals(e.getLast(q)) && b.equals(e.getFirst(q)) && (b = e)),
    ...
    x.prototype = {
      exec: function (c) {
        ...
        for (
          var j = f.createBookmarks(!0), i = [], h = {}, b = b.createIterator(), g = 0;
          (e = b.getNextRange()) && ++g;
  ...
  (function () {
        ...
        place: function () {
          ...
          l.equals(c)
            ...
            : ((k.left =
              ...
              (k.width = i.size.outerWidth + i.size.margin.left + i.size.margin.right + b.scroll.x),
              (k.right = ''));
          e && g
            ? (k.top =
          ...
          return function (e) {
            ...
            if ((e = e.getAscendant(T, 1)) && !e.equals(a.editable) && !e.contains(a.editable)) {
              ...
              (!r(a, f, !b) || ((c = r(a, f, !b)) && m(c) && c.is(a.triggers)))
                ...
                : ((c = I(a, e)),
                  m(c) &&
                    (r(a, c, !b) ? (e = r(a, c, !b)) && m(e) && e.is(a.triggers) && d(c) : d(c)));
            }
          };
        })()
      };
    ...
    function V(a) {
      ...
      return !c && 0 <= b.size.top && 0 < d.y && d.y < b.size.top + f
        ? ((a = a.inInlineMode || 0 === e.scroll.y ? x : s), new u([null, b, D, G, a]))
        : c && b.size.bottom <= e.pane.height && d.y > b.size.bottom - f && d.y < e.pane.height
          ? ((a =
              a.inInlineMode || (b.size.bottom > e.pane.height - f && b.size.bottom < e.pane.height)
                ? y
                : s),
            new u([b, null, W, G, a]))
          : null;
        ...
        f.equals(a.editable[j ? 'getLast' : 'getFirst'](a.isRelevant))
          ...
          (c = [null, f]
            ...
            .concat([
              ...
              G,
              h,
              f.equals(a.editable[j ? 'getLast' : 'getFirst'](a.isRelevant)) ? (j ? y : x) : s
            ]));
    ...
    function ha(a, b, d, e) {
      for (
        var f = e, c = e, h = 0, j = !1, g = !1, i = a.view.pane.height, l = a.mouse;
        l.y + h < i && 0 < l.y - h;
    ...
    var $ = (function () {
        return function (a, b, d) {
          ...
          b &&
            v(a, c) &&
            (f.hide(), (c = new CKEDITOR.dom.element(e.$.elementFromPoint(d.x, d.y))), f.show());
          return !c ||
        ...
        exec: function (a) {
          ...
          if (b.fullPage)
            ...
            d &&
              ...
              d.getAttribute('class') && (b += 'class="' + d.getAttribute('class') + '" '));
            g =
              a.config.docType +
              '<html dir="' +
              a.config.contentsLangDirection +
      ...
      onLoad: function () {
        ...
        CKEDITOR.addCss(
          '.%2 p,.%2 div,.%2 pre,.%2 address,.%2 blockquote,.%2 h1,.%2 h2,.%2 h3,.%2 h4,.%2 h5,.%2 h6{background-repeat: no-repeat;border: 1px dotted gray;padding-top: 8px;}.%2 p{%1p.png);}.%2 div{%1div.png);}.%2 pre{%1pre.png);}.%2 address{%1address.png);}.%2 blockquote{%1blockquote.png);}.%2 h1{%1h1.png);}.%2 h2{%1h2.png);}.%2 h3{%1h3.png);}.%2 h4{%1h4.png);}.%2 h5{%1h5.png);}.%2 h6{%1h6.png);}'
            .replace(/%1/g, 'background-image: url(' + CKEDITOR.getUrl(this.path) + 'images/block_')
        ...
        if (b.state !== CKEDITOR.TRISTATE_DISABLED) {
          ...
          c ||
            ...
            (c.onHide = CKEDITOR.tools.bind(function () {
              this.setState(
                this.modes && this.modes[a.mode] ? b.previousState : CKEDITOR.TRISTATE_DISABLED
              );
            }, this)),
        ...
        c.ui.addRichCombo('Styles', {
          ...
          onRender: function () {
            c.on(
              ...
              function (b) {
                for (
                  var a = this.getValue(), b = b.data.path.elements, c = 0, d = b.length, e;
                  c < d;
                  c++
                ) {
                  e = b[c];
  ...
  (function () {
    ...
    g.prototype = {
      ...
      update: function () {
        this.locked ||
          this.snapshots.splice(this.index, 1, (this.currentImage = new f(this.editor)));
      },
      lock: function () {
